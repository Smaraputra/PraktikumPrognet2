                ...
                <div class="col-md-3">
                    <div class="row text-center">
                        <div class="col-md-12">
                            ...
                            <input type="text" id="prodname" name="product_name" placeholder="Product Name"
                                value="">
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-12">
                            <button type="button" name="category_id" value="0"
                                class="btn default btn-block btnctgry">All Products</button>
                            <br>
                            @foreach ($categories as $category)
                                <button type="button" value="{{ $category->id }}"
                                    class="btn default btn-block btnctgry">{{ $category->category_name }}</button>
                                <br>
                            @endforeach
                        </div>
                    </div>
                                        ...
                                        <div class="fadeshop">
                                            ...
                                            @if ($product->product_image->count())
                                                @foreach ($product->product_image as $image)
                                                    ...
                                                    @else
                                                        <span class="maxproduct"><img
                                                                src="/uploads/product_images/noimage.jpg"
                                                                alt=""></span>
                                                    @endif
                                                @break
                                            @endforeach
                                        ...
                                        @if ($product->discount->count())
                                            ...
                                            @foreach ($product->discount as $key => $diskon)
                                                @if (strtotime($diskon->start) <= $current_date && strtotime($diskon->end) >= $current_date)
                                                    ...
                                                    <span class="price">
                                                        <del
                                                            class="edd_price">Rp.{{ number_format($product->price) }}</del>
                                                    </span>
                                                    <span class="price">
                                                        <span
                                                ...
                                                @else
                                                    @if ($key == 0 && $statusDiskon == 0)
                                                        <span class="price">
                                                            <span
                                                                class="edd_price">Rp.{{ number_format($product->price) }}</span>
                                                        </span>
                                                    @endif
                                                @endif
                                            @endforeach
